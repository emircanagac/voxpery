...
export const EMOJI_CATEGORIES: EmojiCategory[] = [
  ...
  },
  {
    ...
    emojis: [
      ...
      item('🪪', 'identification card', ['id', 'profile', 'identity']),
      item('🧯', 'fire extinguisher', ['safety', 'emergency', 'fire']),
      item('🪫', 'low battery', ['power', 'empty', 'charge']),
      item('🛟', 'ring buoy', ['safety', 'rescue', 'help']),
      item('🪬', 'hamsa', ['protection', 'symbol']),
      item('🩻', 'x-ray', ['health', 'medical']),
      item('🪧', 'placard', ['sign', 'notice']),
      item('🛜', 'wireless', ['wifi', 'network', 'connection']),
    ],
  },
]
