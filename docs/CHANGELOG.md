...
- Made moderator voice moves reuse an active microphone capture in background tabs, tolerate delayed LiveKit destination visibility, report explicit results, and preserve audit success only for verified moves.
